...
do
{
    ...
    sshpass -p "123456" ssh cs4224k@xcnc$n.comp.nus.edu.sg "sh /temp/cs5424_team_k/cockroach-v21.1.7.linux-amd64/CS5424_Project_CockroachDB/runpy.sh $server_num $task_type"
